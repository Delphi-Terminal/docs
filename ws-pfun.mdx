---
title: "Pfun WebSocket"
description: "Real-time price, orderbook, and trade streaming for Pfun markets"
---

## Connection

Connect to the Pfun WebSocket endpoint:
...
| `market_ids` | array | Yes | Array of Pfun market identifiers |
...
ws.onopen = () => {
  console.log("Connected to Pfun WebSocket");
...
- Use `market_id` (Pfun market identifier) to subscribe
